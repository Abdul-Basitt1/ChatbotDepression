...
export default function Map() {
  ...
  const _getLocation = async () => {
    try {
      ...
      console.log('location.coords:', location.coords); // Log location.coords here
      setMyLocation(prevLocation => ({
        ...prevLocation,
        ...location.coords
      }));
      console.log('myLocation after setting:', myLocation); // Add this log
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.buttonContainer}>
        ...
        <Button
          title='Update Location Manually'
          onPress={() => setMyLocation({ latitude: 40.7128, longitude: -74.0060 })}
        />
      </View>
    </View>
  );
